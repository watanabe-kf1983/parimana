...
加えて、各投票券の的中確率と払戻金の期待値も示しています。  

## 画面説明

### オッズ出典

当サイトで競走能力推定の根拠としているオッズの入手ページへのリンクです。
...
オッズから推定されたレース各出走者の競走能力（具体的には走破タイムの確率分布）を示します。  
...
* **mean**  
各出走者の期待されるゴールタイムです。ただし、単位は秒ではありません。    
**全出走者の平均が0**です。この値がマイナスなほど、出走者の好成績が期待されます。  

* **σ**  
各出走者のゴールタイムの期待の幅を示します。  
ゴールタイムは **70%弱** の確率で、mean **±σ**  の範囲におさまると期待されます。

* **q1**, **q3**  
各出走者の期待されるゴールタイムの第1四分位点、第3四分位点を示します。  
ゴールタイムは **50%** の確率で **q1** ～ **q3** の範囲におさまると期待されます。


### 的中確率と払戻期待値

推定された競走能力から算出された、投票券の的中確率と払い戻し額の期待値を示します。  
...
投票券の種類です。意味は次の通りです（競馬の枠連・枠単には対応していません）。
  ...
  * **QUINELLA** : 2連複, 馬複     
  * **WIDE** : 拡連複, ワイド   
  （なおワイドというのは和製英語で、本当は英語では quinella placeというそうです）
  * **TRIFECTA** : 3連単     
  * **TRIO** : 3連複   
...
当サイトは個人による非営利の趣味のサイトです。今後の収益も見込まれていません。  
...
当サイトは著作権を主張しません。これらの数値は当サイトにより算出されたものですが、**著作物としての創作性は無い**と考えています。ちかぢか算出に用いているプログラムソースが公開されれば、数値やグラフは当サイトでなくても算出可能になります。
